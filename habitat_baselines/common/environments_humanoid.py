...
from habitat.core.env_humanoid import RLEnvHumanoid
...
def get_env_class(env_name: str) -> Type[habitat.RLEnvHumanoid]:
    ...
    Returns:
        Type[habitat.RLEnvHumanoid]: env class.
    """
    return baseline_registry.get_env(env_name)


@baseline_registry.register_env_humanoid(name="NavRLEnvHumanoid")
class NavRLEnvHumanoid(habitat.RLEnvHumanoid):
...
@baseline_registry.register_env_humanoid(name="InfoRLEnvHumanoid")
class InfoRLEnvHumaoid(RLEnvHumanoid):
    def __init__(self, config: Config, dataset: Optional[Dataset] = None):
        self._config = config
        self._rl_config = config.RL
        self._core_env_config = config.TASK_CONFIG
