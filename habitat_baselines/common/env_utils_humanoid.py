...
import habitat
from habitat import Config, EnvHumanoid, RLEnvHumanoid, VectorEnvHumanoid, ThreadedVectorEnvHumanoid, make_dataset
from habitat.core.logging import logger


def make_env_fn(
    config: Config, env_class: Type[Union[EnvHumanoid, RLEnvHumanoid]]
) -> Union[EnvHumanoid, RLEnvHumanoid]:
...
def construct_envs_humanoid(
    ...
    envs = habitat.VectorEnvHumanoid(
