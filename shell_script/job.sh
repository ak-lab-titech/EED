...
#CUDA_LAUNCH_BLOCKING=1 python run.py --run-type train_exp --area-reward-type coverage
#CUDA_LAUNCH_BLOCKING=1 python run.py --run-type train_exp --area-reward-type novelty
#CUDA_LAUNCH_BLOCKING=1 python run.py --run-type train_exp --area-reward-type smooth-coverage
#CUDA_LAUNCH_BLOCKING=1 python run.py --run-type train_exp --area-reward-type curiosity
#CUDA_LAUNCH_BLOCKING=1 python run.py --run-type train_exp --area-reward-type reconstruction
