...
class BaselineRegistry(Registry):
    ...
    @classmethod
    def register_env_humanoid(cls, to_register=None, *, name: Optional[str] = None):
        r"""Register a environment to registry with key 'name'
            currently only support subclass of RLEnv.
        ...
        """
        from habitat import RLEnvHumanoid

        return cls._register_impl("env", to_register, name, assert_type=RLEnvHumanoid)
