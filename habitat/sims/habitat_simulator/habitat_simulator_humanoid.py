...
class HabitatSim(Simulator):
    ...
    def __init__(self, config: Config) -> None:
        ...
        motion_path = f"data/humanoids/humanoid_data/{humanoid_name}/{humanoid_name}_motion_data_smplx.pkl"
        ...
        #self.kin_humanoid = kinematic_humanoid.KinematicHumanoid(agent_config, self._sim, pose="stop_pose")  
    ...
    def reconfigure(self, config: Config) -> None:
        ...
        original_state = self.get_agent_state(0)

        #self.kin_humanoid.reconfigure()
        #self.kin_humanoid.base_pos = original_state.position + mn.Vector3(1, 0, 0)
        #self.kin_humanoid.base_rot = -1.57 

        #logger.info(f"humanoid: {self.kin_humanoid.base_pos}") 
